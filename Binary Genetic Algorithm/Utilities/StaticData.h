//
// Created by karee on 11/8/2024.
//


#pragma  once
#include <random>
#define MAKE_SEED   (srand(static_cast<unsigned int>(time(0))));
...
class StaticData {
private:
    static const int MX_GENERATION = 10;
    static const int POPULATION_SIZE = 50;
    static const int MX_ITERATIONS_PER_GENERATION = 1;
