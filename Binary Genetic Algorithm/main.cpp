...
int main() {
    ...
    for (int testcase = 0; testcase < nTestCases; ++testcase) {
        ...
        for (int i = 0; i < chromsome_size; ++i) {
            ...
            genetic_algorithm.add_task(task_execution_time);
        }

        genetic_algorithm.generate_population();
        genetic_algorithm.run();

        auto tasks_execution_time = genetic_algorithm.get_tasks_execution_time();
        Chromosome the_fittest = genetic_algorithm.get_the_fittest();
